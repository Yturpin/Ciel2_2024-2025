...
public:
    ...
    void setupUi(QWidget *TestAlveolesLibres)
    {
        ...
        widget->setGeometry(QRect(90, 60, 481, 231));
        ...
        lineEditNumAlveole = new QLineEdit(widget);
        lineEditNumAlveole->setObjectName("lineEditNumAlveole");
        lineEditNumAlveole->setReadOnly(true);
    ...
    {
        TestAlveolesLibres->setWindowTitle(QCoreApplication::translate("TestAlveolesLibres", "Test des alv\303\251oles libres", nullptr));
